...
*Error: `+dub: command not found+`* - Install D compiler and Dub package
manager

*Error: `+ip: command not found+`* - Install iproute2:
`+sudo dnf install iproute+` or `+sudo apt install iproute2+`

*Permission denied errors:* - Run with sudo for operations that modify
network configuration:
`+bash   sudo ./bin/network-ambulance-d diagnose+`

*Import errors:* - Make sure you’re in the network-ambulance directory -
