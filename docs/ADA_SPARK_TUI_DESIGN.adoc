...
└── tui/
    ├── ada/
    │   ├── network_ambulance_tui.gpr      # GPRbuild project file
    │   ├── src/
    ...
    │   │   │   ├── state_machine.ads
    │   │   │   ├── state_machine.adb
    │   │   │   ├── ipc.ads                # Network Ambulance core IPC
    │   │   │   ├── ipc.adb
    │   │   │   ├── types.ads              # Common types
    │   │   │   └── config.ads             # Compile-time config
    │   │   └── utils/
    │   │       ├── bounded_strings.ads
    │   │       ├── bounded_strings.adb
    │   │       ├── time_utils.ads
...
└────────────────────┬────────────────────────────────────┘
         ...
         └───┬───────────────┬───┘
             │               │
    ┌────────▼──────┐   ┌────▼─────────────┐
    │ State Machine │   │   IPC Manager    │
    │  (verified)   │   │ (core protocol)  │
    └───┬───────────┘   └──────────────────┘
        │
        │ dispatches to
        │
...
----
┌─ Network Ambulance v2.0 ─────────────────────────────────────────────┐
│ [F1] Dashboard  [F2] Diagnostics  [F3] Repairs  [F4] Help  [Q] Quit  │
├───────────────────────────────────────────────────────────────────────┤
│                                                                       │
│ Network Status: 🟢 HEALTHY                                            │
│ ┌─────────────┬─────────────┬─────────────┬─────────────────────┐   │
│ │ Latency     │ DNS Status  │ Routes      │ Interfaces          │   │
│ │ 12ms        │ ✓ OK        │ ✓ OK        │ 2 UP, 0 DOWN        │   │
│ │ [████████░] │ 8.8.8.8     │ Default: OK │ eth0: UP, wlan0: UP │   │
│ └─────────────┴─────────────┴─────────────┴─────────────────────┘   │
│                                                                       │
│ Recent Activity:                                         [↑] [↓] Scroll
│ ┌────────────────────────────────────────────────────────────────┐  │
│ │ [16:30:45] Diagnostic completed - no issues found             │  │
│ │ [16:25:12] DHCP lease renewed on eth0 (192.168.1.100)        │  │
│ │ [16:20:33] DNS switched to 8.8.8.8 (12ms faster)             │  │
│ │ [16:15:01] Interface wlan0 connected to "HomeNetwork"        │  │
│ │ [16:10:22] Background scan completed - all systems nominal   │  │
│ └────────────────────────────────────────────────────────────────┘  │
│                                                                       │
│ Quick Actions:                                                        │
│   [D] Run Diagnostics    [R] Repair Issues    [T] Test Connectivity │
│   [L] View Logs          [S] Settings         [Q] Quit              │
│                                                                       │
└───────────────────────────────────────────────────────────────────────┘
Status: Ready │ CPU: 2% │ Memory: 45MB │ Uptime: 2h 15m
----
...
│                                                                       │
│ ✓ DNS Resolution             [████████████████████] 100%  (12/12)    │
│ ✓ Interface Configuration    [████████████████████] 100%  (2/2)      │
│ ✓ Routing Table              [████████████████████] 100%  (15/15)    │
│ ⟳ Latency Tests              [████████████░░░░░░░]  65%   (13/20)    │
│ ○ Bandwidth Test             [░░░░░░░░░░░░░░░░░░░]   0%   (0/1)      │
│ ○ TCP/UDP Port Checks        [░░░░░░░░░░░░░░░░░░░]   0%   (0/50)     │
│                                                                       │
│ Current Test: Latency to 1.1.1.1                                     │
│ ┌────────────────────────────────────────────────────────────────┐  │
│ │ Ping 1.1.1.1...                                                │  │
│ │ 64 bytes from 1.1.1.1: icmp_seq=1 ttl=56 time=11.2 ms         │  │
│ │ 64 bytes from 1.1.1.1: icmp_seq=2 ttl=56 time=10.8 ms         │  │
│ │ 64 bytes from 1.1.1.1: icmp_seq=3 ttl=56 time=11.5 ms         │  │
│ └────────────────────────────────────────────────────────────────┘  │
│                                                                       │
│ Issues Detected: 0                                                    │
│                                                                       │
│ [C] Cancel Diagnostics    [V] View Full Report    [R] Repair Issues  │
│                                                                       │
└───────────────────────────────────────────────────────────────────────┘
Status: Running diagnostics... │ CPU: 8% │ Memory: 52MB │ ETA: 45s
----
...
│ Detected Issues (3):                                                  │
│                                                                       │
│ [●] 1. Slow DNS Resolution (Current: 45ms, Expected: <20ms)          │
│     Recommended Fix: Switch to faster DNS (1.1.1.1 or 8.8.8.8)       │
│     Impact: Low risk, immediate improvement                          │
│     [ ] Apply this fix                                               │
│                                                                       │
│ [●] 2. Duplicate Default Route                                        │
│     Recommended Fix: Remove redundant route via 192.168.1.254        │
│     Impact: Medium risk, may temporarily disrupt connectivity        │
│     [✓] Apply this fix                                               │
│                                                                       │
│ [ ] 3. MTU Mismatch on wlan0 (Current: 1500, Optimal: 1492)         │
│     Recommended Fix: Adjust MTU to 1492 for PPPoE compatibility      │
│     Impact: Low risk, may improve performance                        │
│     [ ] Apply this fix                                               │
│                                                                       │
│ Selected: 1 repair(s)                                                │
│                                                                       │
│ [Space] Toggle Selection    [A] Select All    [N] Select None        │
│ [Enter] Apply Selected      [C] Cancel        [D] Show Details       │
│                                                                       │
└───────────────────────────────────────────────────────────────────────┘
Status: Ready to repair │ Selected: 1/3 │ Estimated time: <5s
----
...
│ ══════════════                                                        │
│                                                                       │
│ The Dashboard provides real-time monitoring of your network status.  │
│                                                                       │
│ Status Indicators:                                                    │
│   🟢 HEALTHY   - All systems operational                             │
│   🟡 WARNING   - Minor issues detected, no critical problems         │
│   🔴 CRITICAL  - Major issues affecting connectivity                 │
│   ⚪ UNKNOWN   - Unable to determine status                          │
│                                                                       │
│ Keyboard Shortcuts:                                                   │
│   [D]         Run full network diagnostics                           │
│   [R]         Go to repair view (if issues detected)                 │
│   [T]         Test connectivity to common services                   │
│   [L]         View detailed activity logs                            │
│   [S]         Open settings and configuration                        │
│   [F2]        Switch to Diagnostics view                             │
│   [F3]        Switch to Repairs view                                 │
│   [F4]        Show this help screen                                  │
│   [Q] or Esc  Quit Network Ambulance TUI                             │
│   [↑] [↓]     Scroll through activity log                            │
│                                                                       │
│ [PgUp] [PgDn] Navigate Help    [Esc] Close Help                      │
│                                                                       │
└───────────────────────────────────────────────────────────────────────┘
----
...
* Terminal with ≥ 80×24 characters (recommended: 100×30)
...
* ✓ **Safety**: Formally verified absence of runtime errors
* ✓ **Security**: Memory-safe, no undefined behavior
* ✓ **Responsiveness**: Real-time performance without GC pauses
* ✓ **Maintainability**: Strong typing prevents entire classes of bugs
* ✓ **Portability**: Cross-platform terminal support
* ✓ **Reliability**: Critical network operations with proven correctness
