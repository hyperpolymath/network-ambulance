...
git clone <https://github.com/hyperpolymath/network-ambulance.git> cd
network-ambulance
...
toolbox create network-ambulance-dev toolbox enter network-ambulance-dev
...
network-ambulance/ ├── src/ \# Source code (Perimeter 1-2) ├── lib/ \#
...
flake (Perimeter 1) └── Justfile \# Task runner (Perimeter 1)
    ...
    **When suggesting**:
    ...
    - [`good first issue`](https://github.com/hyperpolymath/network-ambulance/labels/good%20first%20issue) — Simple Perimeter 3 tasks
    - [`help wanted`](https://github.com/hyperpolymath/network-ambulance/labels/help%20wanted) — Community help needed
    - [`documentation`](https://github.com/hyperpolymath/network-ambulance/labels/documentation) — Docs improvements
    - [`perimeter-3`](https://github.com/hyperpolymath/network-ambulance/labels/perimeter-3) — Community sandbox scope
